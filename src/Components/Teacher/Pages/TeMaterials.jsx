...
import { BookOpen, Video, FileText, Image ,Plus} from "lucide-react";


function TeMaterials() {
  const materials = [
    {
  ...
  return (
    <div className="flex h-full min-h-screen w-full flex-col bg-gray-50 text-gray-800">
      <main className=" flex-1 p-4 sm:p-6">
        <h1 className="text-2xl font-semibold text-gray-800 pl-2 ">Study Meterials</h1>
        {/* Search & Filter */}
        <div className=" pt-10 mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
